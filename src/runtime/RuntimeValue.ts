// Port of runtime/RuntimeValue.{h,cpp}.
//
// C++ std::variant alternative -> TypeScript representation:
//   std::monostate   -> undefined
//   double           -> number
//   std::int64_t     -> bigint
//   bool             -> boolean
//   std::string      -> string
//   FdPoint3d        -> FdPoint3d (immutable)
//   FdVector3d       -> FdVector3d (immutable)
//   RuntimeArrayPtr  -> RuntimeArray (shared, mutable reference like shared_ptr)
//
// Keep double and int distinct: `typeof v === 'number'` is a double only.

import { CppException, doubleToInt64, formatFixed } from './CppCompat';
...
/** Arrays are shared references (shared_ptr); points/vectors are immutable. */
