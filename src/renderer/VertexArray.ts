// std::vector<Viewport3D::Vertex> as a growable Float32Array with the same
// interleaved layout that the C++ uploads: px, py, pz, r, g, b, nx, ny, nz.
...
export class VertexArray {
  ...
  /** push_back({px, py, pz, r, g, b, nx, ny, nz}) */
  ...
  /** Appends interleaved vertices (a multiple of kVertexFloats floats). */
